...
} elseif ($_instance->childHasBeenRendered('lLNoKuM')) {
    $componentId = $_instance->getRenderedChildComponentId('lLNoKuM');
    $componentTag = $_instance->getRenderedChildComponentTagName('lLNoKuM');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('lLNoKuM');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('lLNoKuM', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('L8eyARo')) {
    $componentId = $_instance->getRenderedChildComponentId('L8eyARo');
    $componentTag = $_instance->getRenderedChildComponentTagName('L8eyARo');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('L8eyARo');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('L8eyARo', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH D:\1\morph\vendor\filament\filament\src\/../resources/views/components/topbar.blade.php ENDPATH**/ ?>