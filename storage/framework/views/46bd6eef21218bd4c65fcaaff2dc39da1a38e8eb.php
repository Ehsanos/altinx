...
} elseif ($_instance->childHasBeenRendered('utFEmfx')) {
    $componentId = $_instance->getRenderedChildComponentId('utFEmfx');
    $componentTag = $_instance->getRenderedChildComponentTagName('utFEmfx');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('utFEmfx');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('utFEmfx', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
