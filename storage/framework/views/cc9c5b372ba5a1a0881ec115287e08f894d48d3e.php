                    ...
                    <div class="col-12 col-lg-3">
                        <div class="row bg-gray pb-3 pt-4">
                            <div class="col-12 p-0 my-1">
                                <div class="d-flex flex-row justify-content-start align-items-center py-1 border-bottom main-catalog">
                                    <div class="div-dash"></div><a class="mx-3 text-decoration-none catalog-btn">الكاتالوج</a>
                                </div>
                            </div>
                            <div class="col-12 p-0 my-1">
                                <div class="d-flex flex-row justify-content-start align-items-center py-1 border-bottom main-catalog">
                            ...
                            <div class="col-12 p-0 my-1">
                                <div class="d-flex flex-row justify-content-start align-items-center py-1 main-catalog">
                                    <div class="div-dash"></div><a class="mx-3 text-decoration-none catalog-btn">الكاتالوج</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-6 col-lg-4 mb-4"><a class="text-decoration-none" href="#">
                                    <div class="product-main border py-1">
                                        ...
                                        <div class="product-desc px-3">
                                            ...
                                            <p class="text-dark m-0 py-2">لوريم ايبسوم هو نموذج افتراضي يوضع في التصاميم لتعرض على العميل ليتصور</p>
                                        </div>
                                        <div class="product-btn px-3 py-2"><a class="text-decoration-none products-details" href="#">تفاصيل المنتج</a></div>
                                    </div>
                                </a></div>
                            <div class="col-6 col-lg-4 mb-4"><a class="text-decoration-none" href="#">
                                    <div class="product-main border py-1">
