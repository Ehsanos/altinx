        ...
        <div class="container-fluid"><a class="navbar-brand d-flex align-items-center"></a>
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item main-link"><a
                            class="nav-link font-weight-bolder <?php if(\Request::route()->getName() =='langs.delegte'): ?> active <?php endif; ?>"
                            href="<?php echo e(route('langs.delegte')); ?>"><?php echo e(lang('delegte')); ?></a></li>
                    <li class="nav-item main-link"><a
                            class="nav-link font-weight-bolder <?php if(\Request::route()->getName() =='langs.jobs'): ?> active <?php endif; ?>"
                            href="<?php echo e(route('langs.jobs')); ?>"><?php echo e(lang('jobs')); ?></a></li>
                    <li class="nav-item main-link"><a
                ...
                <?php else: ?>
                    <div>
                        <a class="btn shadow btn-sign" href="<?php echo e(url('/admin')); ?>" role="button"><?php echo e(lang('login')); ?></a>
