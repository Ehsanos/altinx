        ...
        <div class="container py-4 py-lg-5">
            <div class="row row-cols-2 row-cols-md-4">
                <div class="col-12 col-md-4">
                    ...
                    <div class="pt-2">
                        <form method="post" action="<?php echo e(route('langs.sub')); ?>">
<?php echo csrf_field(); ?>
                            <div class="mb-3"><input class="shadow form-control" type="email" id="email-1" name="email" placeholder="<?php echo e(lang('email')); ?>"></div>
