...
} elseif ($_instance->childHasBeenRendered('w1KIBPX')) {
    $componentId = $_instance->getRenderedChildComponentId('w1KIBPX');
    $componentTag = $_instance->getRenderedChildComponentTagName('w1KIBPX');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('w1KIBPX');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('w1KIBPX', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH D:\1\morph\vendor\filament\filament\src\/../resources/views/components/layouts/card.blade.php ENDPATH**/ ?>