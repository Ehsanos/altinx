        ...
        <div class="container-fluid"><a class="navbar-brand d-flex align-items-center"></a>
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item main-link"><a class="nav-link dropdown font-weight-bolder  @if (\Request::route()->getName() =='langs.products') active @endif"
                    ...
                    <li class="nav-item main-link"><a
                            class="nav-link  font-weight-bolder @if (\Request::route()->getName() =='langs.about') active @endif"
                ...
                {{--<h1 class="bg-danger">{{auth()->user()->name}}</h1>--}}
